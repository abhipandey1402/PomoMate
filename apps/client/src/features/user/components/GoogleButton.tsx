...
const GoogleButton = () => {
    ...
    return (
        <>
        <div className="w-full py-2 bg-white text-black flex-row justify-items-center text-2xl font-semibold rounded-md cursor-pointer " style={{display: "flex", justifyContent: "center", alignItems: "center", gap: "1rem"}} onClick={handleGoogleAuth}>
            <GoogleIcon />
